...
?>
	...
	<style type="text/css">
		...
		.post-<?php echo esc_attr( $id ); ?> { background-color: <?php echo stag_maybe_hash_hex_color( $background_color ); ?> !important; }
		<?php endif; ?>

		<?php if ( ! empty( $background_image ) ) : ?>
		.post-cover-<?php echo esc_attr( $id ); ?> { background-image: url(<?php echo esc_url( $background_image ); ?>); opacity: <?php echo absint( $background_opacity ) / 100; ?>; }
		<?php endif; ?>
	</style>
<div class="post-cover post-cover-<?php echo esc_attr( $id ); ?> stag-image--<?php echo esc_attr( $background_filter ); ?>"></div>
