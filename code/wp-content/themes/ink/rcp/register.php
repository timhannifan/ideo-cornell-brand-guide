	...
	if( $levels ) : ?>
		...
		<ul id="rcp_subscription_levels" class="grid">
			<?php foreach( $levels as $key => $level ) : ?>
				...
				<li class="unit one-of-three rcp_subscription_level rcp_subscription_level_<?php echo $level->id; ?>">
					...
					<label for="rcp_subscription_level_<?php echo $level->id; ?>">
						<span class="rcp_subscription_level_name"><?php echo rcp_get_subscription_name( $level->id ); ?></span><span class="rcp_price" rel="<?php echo esc_attr( $level->price ); ?>"><?php echo $level->price > 0 ? rcp_currency_filter( $level->price ) : __( 'free', 'rcp' ); ?><span class="rcp_separator">&nbsp;-&nbsp;</span></span>
		...
		if( count( $gateways ) > 1 ) : $display = rcp_has_paid_levels() ? '' : ' style="display: none;"'; ?>
			<fieldset class="rcp_gateways_fieldset">
				<p id="rcp_payment_gateways"<?php echo $display; ?>>
					...
					<select name="rcp_gateway" id="rcp_gateway" class="half-width">
